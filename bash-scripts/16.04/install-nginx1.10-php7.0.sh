...
apt_get_packages=( "git" "php7.0-fpm" "php7.0-mysql" "php7.0-gd" "php7.0-cli" "php7.0-common" "php7.0-json" "php7.0-curl" "php7.0-mcrypt" "php7.0-readline" "php-mongodb" "php-redis" "php7.0-sqlite" "php7.0-bcmath" "php7.0-mbstring" "php7.0-xml" ); # "python-pip"

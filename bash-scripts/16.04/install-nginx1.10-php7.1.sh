...
apt_get_packages=( "git" "php7.1-fpm" "php7.1-mysql" "php7.1-gd" "php7.1-cli" "php7.1-common" "php7.1-json" "php7.1-curl" "php7.1-mcrypt" "php7.1-readline" "php-mongodb" "php-redis" "php7.1-sqlite" "php7.1-bcmath" "php7.1-mbstring" "php7.1-xml" "php7.1-intl"); # "python-pip"
